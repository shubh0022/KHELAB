...
import { Wind, Activity, Zap, Play, Layers } from "lucide-react";
    ...
    <div className="glassmorphic rounded-2xl p-6 space-y-6 flex-1 flex flex-col min-h-[600px] text-[#f5f5f7]">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 flex-1">
        ...
        <div className="xl:col-span-1 p-5 rounded-2xl bg-white/[0.01] border border-white/[0.04] flex flex-col justify-between space-y-6 font-sans">
          ...
          <div className="p-3.5 bg-white/[0.02] border border-white/[0.04] rounded-xl text-[10px] text-slate-400 space-y-1">
            <span className="text-slate-500 font-semibold block uppercase text-[8px] tracking-wider mb-1">
              Simulated Energy Output
            </span>
            ...
            <div className="flex justify-between">
              <span>Friction Resistance Force:</span>
              <span className="text-white font-medium">{(9.81 * friction * activeAthlete.weight * 0.1).toFixed(2)} N</span>
            </div>
            <div className="flex justify-between pt-1 border-t border-white/[0.04] text-[9px] text-[#ff3b30]">
              <span>Dynamic Muscle Strain:</span>
              <span className="font-semibold">{activeAthlete.injuryRisk > 25 ? "Caution Load" : "Nominal"}</span>
            </div>
          </div>
